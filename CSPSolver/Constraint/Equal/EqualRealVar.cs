...
{
    public readonly struct EqualRealVar : IConstraint
    {
        ...
        public EqualRealVar(IRealVar var1, IRealVar var2) => (_var1, _var2) = (var1, var2);
        ...
        public bool CanBeMet(IState state) =>
            AreTrue(_var1.GetDomainMin(state), _var2.GetDomainMax(state), (v1, v2) => v1 < v2, IsEqual) &&
            AreTrue(_var1.GetDomainMax(state), _var2.GetDomainMin(state), (v1, v2) => v1 > v2, IsEqual);
