...
namespace CSPSolver.Math.Round
{
    public readonly struct Ceil : IIntVar, ICompoundVariable
    {
        ...
        public int GetDomainMax(IState state) => (int)Ceiling(_realVar.GetDomainMax(state));

        public int GetDomainMin(IState state) => (int)Ceiling(_realVar.GetDomainMin(state));
