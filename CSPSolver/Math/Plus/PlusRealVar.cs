...
namespace CSPSolver.Math.Plus
{
    public readonly struct PlusRealVar : IRealVar, ICompoundVariable
    {
        ...
        public double GetDomainMax(in IState state) => _v1.GetDomainMax(state) + _v2.GetDomainMax(state);

        public double GetDomainMin(in IState state) => _v1.GetDomainMin(state) + _v2.GetDomainMin(state);
