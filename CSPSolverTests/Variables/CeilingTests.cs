...
namespace CSPSolverTests.Variables
{
    ...
    {
        private static (IState state, RealVar variable, Ceil truncate) GetVar(double min, double max)
        {
            ...
            return (state, variable, new Ceil(variable));
        }
        ...
        public void GetMax()
        {
            ...
            Assert.AreEqual(Ceiling(max), t.GetDomainMax(s));
        ...
        public void GetMin()
        {
            ...
            Assert.AreEqual(Ceiling(min), t.GetDomainMin(s));
